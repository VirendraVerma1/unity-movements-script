...
public class AdScript : MonoBehaviour, IUnityAdsListener 
{
    ...
    //---unity ads variables
    string gameId = "4012729";
    string mySurfacingId = "rewardedVideo";
    public string surfacingId = "bannerPlacement";
    bool testMode = true;

    //----google admob variable
    string AppId = "ca-app-pub-4773340848320054~7924085269";
    string RewardAdd = "ca-app-pub-3940256099942544/5224354917";//"ca-app-pub-4773340848320054/5106350237";
    string interstitialAdd = "ca-app-pub-3940256099942544/1033173712";//"ca-app-pub-3940256099942544/1033173712";//"ca-app-pub-4773340848320054/7568862044";
    ...
    {
        if (adnetValue == "0")//means google ads
        {
        ...
        else if (adnetValue == "1")//means unity ads
        {
    ...
    {
        isgotReward=false;
        if (adnetValue == "0")//means google ads inter to show
        {
            ShowInterstitial();
        }
        else if (adnetValue == "1")//means google ads inter to show
        {
            Advertisement.Show();
        }
    }
    ...
    {
        isgotReward=false;
        if (adnetValue == "0")//means google ads reward to show
        {
            ShowRewardedAds();
        }
        else if (adnetValue == "1")//means unity ads reward to show
        {
            ShowRewardedVideo();
        }
    }
